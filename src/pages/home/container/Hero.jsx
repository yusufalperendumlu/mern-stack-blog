    ...
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        ...
        <p className="text-dark-light mt-4 text-center md:text-lg lg:text-base xl:text-xl lg:text-left">
          ...
          tenetur non labore obcaecati, beatae impedit blanditiis ex fuga nihil
          ut, similique aliquid alias eos cumque illum exercitationem,
      ...
      <div className="hidden lg:block lg:ml-2 lg:1/2">
        <img
          className="w-full"
